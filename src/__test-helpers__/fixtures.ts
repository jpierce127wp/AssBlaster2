...
import type { EvidenceEvent } from '../evidence/evidence.types.js';
...
import type { DedupCandidate } from '../dedup/dedup.types.js';
import type { ReviewItem } from '../review/review.types.js';
import type { ClioTaskLink } from '../sync/sync.types.js';
import type {
  EvidenceEventId,
  CandidateTaskId,
  CanonicalTaskId,
